...
public final class MessageBundle {
  ...
  public static final String ERROR_NO_GAMES_SAVED = "error.no.games.saved";
  ...
  public static final String MENU_SELECT_GAME = "menu.select.game";
  ...
  public static final String MENU_RESUME_GAME = "menu.resume.game";
  public static final String MENU_SAVE_GAME = "menu.save.game";
  public static final String MENU_ENTER_SAVE_ID = "menu.enter.save.id";
